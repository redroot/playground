...
var _user$project$Models$initialModel = function (route) {
	return {players: _krisajenkins$remotedata$RemoteData$Loading, route: route};
};
...
var _user$project$Models$PlayerRoute = function (a) {
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$PlayersRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$PlayerRoute,
				A2(
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$PlayersRoute,
					_evancz$url_parser$UrlParser$s('players')),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Players_List$list = function (playerList) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Players_List$playerRow, playerList)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
